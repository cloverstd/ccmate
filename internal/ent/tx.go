...
func (tx *Tx) init() {
	...
	tx.CommandAudit = NewCommandAuditClient(tx.config)
	tx.ExecutionLease = NewExecutionLeaseClient(tx.config)
	tx.Project = NewProjectClient(tx.config)
	tx.ProjectLabelRule = NewProjectLabelRuleClient(tx.config)
	tx.PromptTemplate = NewPromptTemplateClient(tx.config)
	tx.PromptTemplateSnapshot = NewPromptTemplateSnapshotClient(tx.config)
