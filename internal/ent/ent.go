...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			commandaudit.Table:           commandaudit.ValidColumn,
			executionlease.Table:         executionlease.ValidColumn,
			project.Table:                project.ValidColumn,
			projectlabelrule.Table:       projectlabelrule.ValidColumn,
			prompttemplate.Table:         prompttemplate.ValidColumn,
			prompttemplatesnapshot.Table: prompttemplatesnapshot.ValidColumn,
